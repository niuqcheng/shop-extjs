...
const list = ref<any>([
  {
    ...
    icon: 'illustration/IconPark03',
  },
  {
    title: '在线零售',
    description: '打造全域营销运营闭环',
    icon: 'illustration/IconPark05',
  },
  {
    title: '珠宝首饰',
    description: '沉淀私域消费者数据资产',
    icon: 'illustration/IconPark07',
  },
  {
    title: '商用软件',
    description: '深度洞察企业客户需求',
    icon: 'illustration/IconPark08',
  },
  {
    title: '消费电子',
    description: '用户精准营销与智能触达通路',
    icon: 'illustration/IconPark04',
  },
  {
    title: '智能家居',
    description: '智能家居场景化运营',
    icon: 'illustration/IconPark02',
  },
])
